...
def get_all_entrepots():
    """
    Liste de tous les entrepôts avec exploitation et pays
    """
    try:
...
def get_entrepot(entrepot_id):
    """
    Récupère les infos de l'entrepôt avec exploitation et pays
    """
    try:
...
def get_mesures_by_entrepot(entrepot_id):
    """
    Récupère les mesures température/humidité sur la période
    """
    try:
...
def get_lots_by_entrepot(entrepot_id):
    """
    Liste des lots stockés triés par datSto croissante (FIFO)
    """
    try:
...
def create_lot_in_entrepot(entrepot_id):
    """
    Créer un nouveau lot dans cet entrepôt
    """
    try:
